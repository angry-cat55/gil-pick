...
class RouteFailureCode(StrEnum):
    ...
    # 가까운 대중교통 구간을 도보로 대체하려 했지만 도보 경로도 찾지 못했다(#685).
    ROUTE_SHORT_DISTANCE_NOT_FOUND = "ROUTE_SHORT_DISTANCE_NOT_FOUND"
...
class RouteSegment(ApiModel):
    ...
    # 사용자는 대중교통을 골랐지만 너무 가까워 경로가 없어 도보로 대신 계산했다(#685).
...
__all__ = [
    "FailedRouteData", "NotCalculatedRouteData", "Provider", "ReadyRouteData",
    "RetryRouteRequest", "Route", "RouteData", "RouteEnvelope", "RouteEstimateRequest",
    "RouteFailure", "RouteFailureCode", "RouteGeometry", "RouteMarker", "RouteModeEstimate",
    "RouteSegment", "RouteSegmentEstimatesData", "RouteSegmentEstimatesEnvelope", "RouteStatus",
    "RouteStep", "RouteStepType", "TransportMode",
]
