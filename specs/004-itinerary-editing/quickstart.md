...
- PR 직전 최신화: `origin/main` 2c31a1b를 병합해 F005·F006·F007 변경을 반영한 뒤 Backend F004 64건, Android itinerary·trip unit test와 `assembleDebug`, API 36 AVD의 itinerary·trip `connectedDebugAndroidTest`를 다시 실행해 모두 통과했다.
