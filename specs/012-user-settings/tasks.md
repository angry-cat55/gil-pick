...
- [x] T018 [US2] 승인 URL 검증과 Custom Tabs launcher 구현 in android/app/src/main/java/com/gilpick/settings/PolicyDocumentLauncher.kt
  - 영역: FE
  - 담당: hs
  - 선행: T017, 제품·운영 담당자의 승인된 두 HTTPS URL 제공
  - 진행(2026-09-11): 구현과 unit test는 완료. 승인된 HTTPS URL 2개가 없어 보류했다
  - 완료(2026-09-11, jy): 승인 URL을 `android/gradle.properties`에 확정(`https://gilpick.pages.dev/privacy/`, `/terms/`). 원본은 `web/privacy`, `web/terms`
...
- [x] T019 [US2] 정책 항목·열기 실패·재시도 상호작용을 설정 화면에 연결 in android/app/src/main/java/com/gilpick/settings/SettingsScreen.kt and android/app/src/main/java/com/gilpick/settings/SettingsViewModel.kt
  - 영역: FE
  - 담당: hs
  - 선행: T015, T018
  ...
  - 완료(2026-09-11, jy): T018 URL 확정으로 해소

- [x] T020 [US2] 정책 문서 진입·복귀·오류 Compose UI test 작성 in android/app/src/androidTest/java/com/gilpick/settings/SettingsPolicyTest.kt
  - 영역: FE
  - 담당: hs
  - 선행: T019
  ...
  - 진행(2026-09-11): Compose UI test 10개 작성·통과. 수동 5회 3초 측정(SC-005)은 승인된 URL이 없어 미실행이었다
  - 완료(2026-09-11, jy): emulator `gilpick_api36_play`(API 36, Chrome)에서 각 문서 5회 측정, 전부 0.87~1.75초로 3초 이내. 기록은 `quickstart.md` 4절
