...
- 기간 축소 확인 대화상자에 `9월 15일 · 2곳`처럼 날짜별 삭제 일정 수가 보이는지 확인(FR-013a, #589)
- 대표 이미지가 있는 여행이 목록 카드에 보이는지, 편집에서 이미지를 추가·변경·삭제하고 목록으로 돌아왔을 때 각각 새 이미지·기본 표시로 바뀌는지 확인(FR-019a, #617)
