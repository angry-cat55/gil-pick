...
- 하나 이상의 변수가 위험이면 `ACTIVE` 감지 결과를 생성한다. 장소 변경 제안 알림은 F011에서 처리하며, 종합 위험 점수 50점 이상이거나 운영시간 방문 불가일 때만 보낸다(2026-09-16 #585). 그 미만인 감지 결과도 생성 자체는 그대로 되어 감지 목록·배너에는 나타난다.
