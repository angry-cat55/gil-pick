...
| F009 | 대체 장소 추천 | F003의 장소·Google 보강 계약을 재사용해 변동 조건에 맞는 대체 후보 추천 | F003, F008 | IN_PROGRESS | jy |
...
- `VERIFY`: T038 Backend quickstart와 T039 Android·실서버 검증이 완료되는 PR에서 반영한다.
- `DONE`: F009 관련 PR이 모두 `main`에 병합된 뒤 반영한다.
